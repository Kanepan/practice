...
public class ImageSimilar {
    ...
    public ImageSimilar(byte[] hashValue) {
    ...
    public ImageSimilar(String hashValue) {
        this(toBytes(hashValue));
    }

    public ImageSimilar(BufferedImage src) {
        this(hashValue(src));
    }
    ...
    public static ImageSimilar createFromCompact(byte[] compactValue) {
        return new ImageSimilar(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ImageSimilar) {
            return Arrays.equals(this.binaryzationMatrix, ((ImageSimilar) obj).binaryzationMatrix);
        } else
    ...
    public float compare(String hashValue) {
        return compare(new ImageSimilar(hashValue));
    }
    ...
    public float compare(BufferedImage image2) {
        return compare(new ImageSimilar(image2));
    }
     ...
     */
    public float compare(ImageSimilar src) {
    ...
    public static float compare(BufferedImage image1, BufferedImage image2) {
        return new ImageSimilar(image1).compare(new ImageSimilar(image2));
    }
...
//        ImageSimilar fp2 = new ImageSimilar(ImageIO.read(new File(path + "1596792477816.png")));
        ImageSimilar fp1 = new ImageSimilar(ImageIO.read(new File(path + "1595491059939.png")));
        ImageSimilar fp2 = new ImageSimilar(ImageIO.read(new File(path + "1595491140320.png")));
