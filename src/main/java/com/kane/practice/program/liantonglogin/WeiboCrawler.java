...
public class WeiboCrawler   {
    ...
    public static void testSelenium() throws IOException, InterruptedException {
    	...
    	int waitLoadRandomTime = 4000;
    	Random random = new Random(System.currentTimeMillis());
        System.getProperties().setProperty("webdriver.chrome.driver", "C:\\Users\\Kanep\\Desktop\\chromedriver.exe");
        ChromeDriverService service = new ChromeDriverService.Builder()
        .usingDriverExecutable(
        new File(
        "C:\\Users\\Kanep\\Desktop\\chromedriver.exe"))
...
//      driver.findElement(By.id("loginPassword")).sendKeys("KANG316316jia");
      ...
      //找到登录按钮，点击
		System.err.println("-------------" + driver.findElement(By.linkText("登录")).getText());
      driver.findElement(By.linkText("登录")).click();
      Thread.sleep(2000);
      //然后这个页面就会进入到登录后的界面了

		System.err.println("-------------" + driver.findElement(By.className("Bv6_layer")).findElement(By.className("password")).getText());

		WebElement layer = driver.findElement(By.className("Bv6_layer"));

//		ActionChains(driver).move_to_element(element).perform()


		Actions actions = new Actions(driver);
		actions.moveToElement(layer.findElement(By.className("username")));
		actions.click(layer.findElement(By.className("username"))).perform();
		actions.sendKeys("hhg531@163.com").perform();
		Thread.sleep(1000);
//		layer.findElement(By.className("username")).sendKeys("hhg531@163.com");

		actions.moveToElement(layer.findElement(By.className("password")));
		actions.click(layer.findElement(By.className("password"))).perform();;
		Thread.sleep(1000);
//		layer.findElement(By.className("password")).sendKeys("KTOakn3764U");
		layer.findElement(By.cssSelector("a[action-type=btn_submit]")).click();
		actions.sendKeys("hhg531@163.com").perform();
