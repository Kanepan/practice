...
//        System.out.println(html);
        ...
        header.put("Referer", "https://login.sina.com.cn/crossdomain2.php?action=login&r=https://api.weibo.com/oauth2/authorize?client_id=2766276024&redirect_uri=http://uac.10010.com/portal/SinaWeiboLogin&response_type=code");
        ...
        for (Object o : ja) {
            url = URLDecoder.decode(o.toString(), "utf-8");
...
//        System.out.println(r3);
        ...
        r3 = HttpClientUtil.get(url, header, client);
        System.out.println(r3);


        for (int i = 0; i < 20; i++) {
            url = "https://upay.10010.com/npfweb/NpfWeb/cardquery/cardStateQuery.action?callback=getCardState&commonBean.cardValue="  + (981908765103244L + 0);
